...
# TODO На вход - массив функций. На выходе упорядоченные по возрастанию функции.
# TODO Сделать запись в таблицу csv? Подумать, как расширить функционал.
# TODO Сделать графики
# TODO еще режим - сравнения (о, тета, омега)
